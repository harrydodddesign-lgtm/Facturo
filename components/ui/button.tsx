...
// Note: I'm not using Radix UI primitives for everything to keep it simple, 
// but I'll use the pattern. I don't have @radix-ui/react-slot installed, 
// so I'll implement a simpler version or just standard props.
// Actually, I'll just use standard props for now to avoid extra deps unless needed.
